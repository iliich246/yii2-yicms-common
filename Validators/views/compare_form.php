...
use Iliich246\YicmsCommon\Validators\CompareValidatorForm;
use Iliich246\YicmsCommon\Languages\Language;

/** @var $this \yii\web\View */
/** @var $validatorForm CompareValidatorForm */
...
<div class="modal-content">
    ...
    <div class="modal-body">
        ...
        <p>In string you can place next placeholders: {attribute}, {value}, {compareValue},
            {compareAttribute}, {compareValueOrAttribute}</p>
        ...
        <?= $form->field($validatorForm, 'type')->dropDownList($validatorForm->getTypesList()) ?>

        <?= $form->field($validatorForm, 'operator')->dropDownList($validatorForm->getOperatorsList()) ?>

        <?= $form->field($validatorForm, 'compareValue') ?>
